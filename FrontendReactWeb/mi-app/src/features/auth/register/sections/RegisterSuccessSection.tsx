  ...
  return (
    <div className="flex flex-col items-center justify-center gap-5 py-10">
      <div className="relative flex items-center justify-center">
        <span
          className="absolute w-20 h-20 rounded-full bg-[#4fbe8e]/10 animate-ping"
      ...
      <div className="text-center space-y-1">
        <h3 className="text-[#e4ebf5] text-xl font-light tracking-wide">
      ...
      <div className="w-40 h-0.5 bg-[#1a2235] rounded-full overflow-hidden">
        <div
          className="h-full bg-[#4fbe8e] rounded-full"
