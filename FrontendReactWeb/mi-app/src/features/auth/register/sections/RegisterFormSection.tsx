...
=======
  ...
  return (
    <form onSubmit={handleFormSubmit} noValidate className="form" method="post">
      ...
      <p className="terms">
<<<<<<< HEAD:FrontendReactWeb/mi-app/src/features/register/sections/RegisterFormSection.tsx
        Al crear tu cuenta aceptas los términos de servicio.
=======
        Ya tienes cuenta? <a href="/login">Inicia sesion</a>

>>>>>>> dff76de22c0a24dc5ae37d61aec817b910d4b235:FrontendReactWeb/mi-app/src/features/register/sections/RegisterFormSection.tsx
>>>>>>> bb18ddb23a5877a401d5a6e8f1b5a9a64e48a0e9:FrontendReactWeb/mi-app/src/features/auth/register/sections/RegisterFormSection.tsx
      </p>
    </form>
  );
}
