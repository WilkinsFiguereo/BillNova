...
export const NAV_ITEMS: NavItemData[] = [
  ...
  { id: "bitacora", Icon: Shield, label: "Bitacora", href: "/navigation/seller/bitacora/page" },
  { id: "impuestos", Icon: Receipt, label: "Impuestos", href: "/navigation/seller/impuestos/page" },
  { id: "config", Icon: Settings, label: "Configuracion", href: "/navigation/config?role=seller" },
];
