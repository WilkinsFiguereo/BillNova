...
export default function CompanyRegisterPage() {
      ...
      <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: C.bgPrimary, fontFamily: font }}>
        ...
        <main style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
          ...
          >
            ...
            <a
              href="/navigation/seller/company_config/page"
              style={{
      ...
      <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: C.bgPrimary, fontFamily: font }}>
        ...
        <main style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
          ...
          >
            ...
            >
              <PartyPopper size={44} color={C.success} />
            </div>
            ...
            <p style={{ fontSize: 14, color: C.textSecondary, lineHeight: '22px', margin: '0 0 24px' }}>
              Tu cuenta empresarial fue creada correctamente.
              <br />
  ...
  const renderSection = () => {
    switch (currentStep) {
      case 1:
        return <CompanyInfoSection {...sharedProps} />;
      case 2:
        return <ContactSection {...sharedProps} />;
      case 3:
        return <AddressSection {...sharedProps} />;
      case 4:
        return (
          <AccountSection
            {...sharedProps}
      ...
      case 5:
        return <BusinessTypeSection {...sharedProps} />;
      case 6:
        return formData.businessType === 'services' ? (
    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: C.bgPrimary, fontFamily: font }}>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        >
          ...
          <span style={{ fontSize: 13, color: C.textSecondary }}>Crea tu empresa para continuar</span>
        </header>
              ...
              <div style={{ display: 'flex', gap: 12, padding: '0 32px 32px' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    height: 52,
                    backgroundColor: isLoading ? '#6B8FCC' : C.brand600,
                    color: C.white,
                    fontWeight: 700,
                    fontSize: 15,
                    border: 'none',
