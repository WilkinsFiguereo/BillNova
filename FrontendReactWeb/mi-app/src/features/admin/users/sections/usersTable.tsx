...
function UserRow({ user, userType, deleting, onDelete, onEdit, onView }: {
  ...
  return (
    <tr>
      ...
      <td style={td}><Badge active={user.active} /></td>
...
function Table({ users, userType, deleting, onDelete, onEdit, onView }: {
  ...
  return (
    <table style={{ width: "100%", borderCollapse: "collapse" }}>
      ...
      <tbody>
        {users.map(u => (
          <UserRow key={u.id} user={u} userType={userType} deleting={deleting} onDelete={onDelete} onEdit={onEdit} onView={onView} />
        ))}
      </tbody>
    </table>
  );
...
export function UsersTable({ resUsers, billnovaUsers, deleting, onDelete, onEdit, onView }: UsersTableProps) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <button style={tabBtn("res")}      onClick={() => setTab("res")}>
          RES ({resUsers.length})
        </button>
        <button style={tabBtn("billnova")} onClick={() => setTab("billnova")}>
