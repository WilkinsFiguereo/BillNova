...
import { exportModeratorDatasetToExcel, exportModeratorDatasetToPdf } from './reportExport';
    ...
    >
      ...
      <main style={{ flex: 1, overflow: 'auto', padding: '32px 28px' }}>
        <div style={{ maxWidth: 1320, margin: '0 auto', display: 'grid', gap: 18 }}>
          <section style={{ ...cardStyle(colors.brand), padding: 26 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', gap: 18, flexWrap: 'wrap', alignItems: 'center' }}>
              <div>
                <p style={{ margin: 0, color: colors.brand, fontSize: 12, fontWeight: 800, letterSpacing: '.08em', textTransform: 'uppercase' }}>
                  Centro de reportes
                </p>
                <h1 style={{ margin: '8px 0 6px', color: colors.text, fontSize: 32, lineHeight: 1.1 }}>
                  Reportes PDF y Excel de empresas, productos, ventas y usuarios
                </h1>
                <p style={{ margin: 0, maxWidth: 760, color: colors.subtext, fontSize: 14 }}>
                  Exporta analítica real del marketplace y revisa rendimiento por empresa, catálogo, ventas y actividad de usuarios.
                </p>
              </div>
          ...
          <section style={cardStyle()}>
            <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, alignItems: 'center', marginBottom: 16 }}>
              <div>
                <h2 style={{ margin: 0, fontSize: 20, color: colors.text }}>Top empresas por ingresos</h2>
                <p style={{ margin: '6px 0 0', color: colors.subtext, fontSize: 13 }}>Ranking comercial del periodo seleccionado.</p>
              </div>
            </div>
            <DataTable
